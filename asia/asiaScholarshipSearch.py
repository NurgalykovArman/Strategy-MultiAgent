    ...
    try:
        ...
        if len(scholarship_json) > 2000:
            ...
            truncated_data = {
                ...
                "requirements": scholarship_data.get("requirements", "")[:300] if scholarship_data.get("requirements") else ""
            }
            ...
            try:
                ...
                if not deadlines:
                    ...
                    for i, d in enumerate(deadlines, 1):
                        ...
                        print(f"   Requirements: {d['requirements'][:100]}..." if len(d['requirements']) > 100 else f"   Requirements: {d['requirements']}")
                        print()
            except ValueError:
